    ...
    <div class="container-fluid">
        ...
        <?= form_open_multipart('menu/tambahsubstandar'); ?>
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="kode_sub_standar" name="kode_sub_standar" class="form-control" placeholder="Menu Ke-">
                    <?= form_error('kode_sub_standar', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>
                <div class="form-group">
                    <label for="nama_sub">Nama substandar</label>
                    <input type="text" id="nama_sub_standar" name="nama_sub_standar" class="form-control" placeholder="nama...">
                    <?= form_error('nama_sub_standar', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>
                <div class="form-group">
                    <label for="nama_sub_standar">Standar</label>
                    <select name="kode_standar" id="kode_standar" class="form-control">
                        <?php
                        $i = 1;
