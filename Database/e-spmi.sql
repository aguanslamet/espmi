...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 31 Jan 2021 pada 01.39
...
INSERT INTO `dokumen_pendukung` (`id`, `nama`, `file`, `kode_mr`) VALUES
...
(31, 'dokumen ketentuan pakaian bagi mahasisiwa', 'The_Basics_of_Visual_Studio_Code.pdf', 9);

-- --------------------------------------------------------

--
-- Struktur dari tabel `manajemen_refrensi`
--

CREATE TABLE `manajemen_refrensi` (
  `kode_mr` int(11) NOT NULL,
  `nama` varchar(128) NOT NULL,
...
CREATE TABLE `standar` (
  `kode_standar` int(11) NOT NULL,
  `nama_standar` varchar(128) NOT NULL,
  `deskripsi` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `standar` (`kode_standar`, `nama_standar`, `deskripsi`) VALUES
(1, 'Lembaga Standar', 'Lembaga Standar yaitu lembaga yang menyusun dan mengelola Standar dalam Proses Akreditasi PT.'),
(2, 'SPM FASTIKOM', 'SPM FASTIKOM merupakan sistem Penjaminan Mutu di Lingkup Fakultas Teknik dan ilmu Komputer, yang di harapkan bisa meningkatkan setandar mutu bagi Fakultas');
...
CREATE TABLE `sub_standar` (
  `kode_sub_standar` int(11) NOT NULL,
  `nama_sub_standar` varchar(128) NOT NULL,
  `kode_standar` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `sub_standar` (`kode_sub_standar`, `nama_sub_standar`, `kode_standar`) VALUES
(1, 'SPMI', 1),
(2, 'Regulasi dan Kebijakan', 2),
(3, 'SPME', 1),
(4, 'Tentang SPm fastikom', 2);

-- --------------------------------------------------------

--
-- Struktur dari tabel `sub_sub_standar`
--

CREATE TABLE `sub_sub_standar` (
  `kode_sub_sub_standar` int(11) NOT NULL,
  `nama_sub_sub_standar` varchar(128) NOT NULL,
  `kode_sub_standar` int(11) NOT NULL,
  `url` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `sub_sub_standar`
--

INSERT INTO `sub_sub_standar` (`kode_sub_sub_standar`, `nama_sub_sub_standar`, `kode_sub_standar`, `url`) VALUES
(1, 'Setandar Perkuliahaan', 1, 'halaman/detail/setandar-perkuliahan'),
(2, 'Elemen SPMI', 1, 'halaman/detail/Elemen-SPMI'),
(3, 'Setandar Mutu', 1, 'halaman/detail/Setandar-Mutu'),
(4, 'Undang-Undang', 2, 'halaman/detail/undang-undang'),
(5, 'Peraturan Pemerintah', 2, 'halaman/detail/peraturan-pemerintah'),
(6, 'BAN-PT', 3, 'Halaman/detail/BAN-PT'),
(7, 'LAM-Aptikom', 3, 'halaman/detail/LAM-Aptikom'),
(8, 'Struktur Organisasi SPM', 4, 'halaman/detail/Struktur-Organisasi-SPM'),
(9, 'Visi dan Misi SPM-Fastikom', 4, 'halaman/Detail/Visi-dan-Misi-SPM-Fastikom'),
(10, 'Fungsi dan Tugas SPM', 4, 'halaman/detail/Fungsi-dan-Tugas-SPM');
...
(7, 'Ma\'ruf', 'm@gmail.com', '081234567890', 'mstudio.png', '$2y$10$5D60Tsoq7bwch8pOMlXYvOvE5UxuYt6OLkFAXfnAGnvWIgiJgst6e', 1, 1610879162, 1),
...
--
-- Indeks untuk tabel `manajemen_refrensi`
--
ALTER TABLE `manajemen_refrensi`
  ADD PRIMARY KEY (`kode_mr`);

--
-- Indeks untuk tabel `standar`
--
ALTER TABLE `standar`
  ADD PRIMARY KEY (`kode_standar`);

--
-- Indeks untuk tabel `sub_standar`
--
ALTER TABLE `sub_standar`
  ADD PRIMARY KEY (`kode_sub_standar`);

--
-- Indeks untuk tabel `sub_sub_standar`
--
ALTER TABLE `sub_sub_standar`
  ADD PRIMARY KEY (`kode_sub_sub_standar`);
...
--
-- AUTO_INCREMENT untuk tabel `manajemen_refrensi`
--
ALTER TABLE `manajemen_refrensi`
  MODIFY `kode_mr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT untuk tabel `standar`
--
ALTER TABLE `standar`
  MODIFY `kode_standar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `sub_standar`
--
ALTER TABLE `sub_standar`
  MODIFY `kode_sub_standar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `sub_sub_standar`
--
ALTER TABLE `sub_sub_standar`
  MODIFY `kode_sub_sub_standar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
